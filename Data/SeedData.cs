...
namespace DinnerMe.Data
{
    public class SeedData
    {
        public static void Initialize(DinnerMeContext db) {
            ...
            var barra_ingredient = new Ingredient() { name = "Barra", measurement = Ingredient.UnitOfMeasurement.Quantity };
            var courgette_ingredient = new Ingredient() { name = "Courgette", measurement = Ingredient.UnitOfMeasurement.Quantity };
            var sausage_ingredient = new Ingredient() { name = "Sausages", measurement = Ingredient.UnitOfMeasurement.Quantity };
            var beans_ingredient = new Ingredient() { name = "Beans", measurement = Ingredient.UnitOfMeasurement.Cans };
            var salmon_ingredient = new Ingredient() { name = "Salmon", measurement = Ingredient.UnitOfMeasurement.Quantity };
            var potatoes_ingredient = new Ingredient() { name = "Potatoes", measurement = Ingredient.UnitOfMeasurement.Quantity };
            var sfd_green_olives_ingredient = new Ingredient() {
                name = "Stuffed Green Olives", measurement = Ingredient.UnitOfMeasurement.Tubs };
                ...
                new Dinner() {
                    ...
                    sides = new Side[] {
                        ...
                        new Side() { name = "Test Second Side",
                                     ...
                                     notes = "None",
                                     ingredients = new List<MealIngredient> {
                                         new MealIngredient{ ingredient = test_ingredient, quantity = 100 }
                                     },
                                   }
                    }.ToList<Side>()
                }
